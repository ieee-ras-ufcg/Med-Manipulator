...
final_position = [math.pi/2, math.pi/4, 0.10, math.pi/2]

params = {
    'joints': [joint1, joint2, joint3, joint4],  
    'targetPos': final_position,               
    'maxVel': [0.5, 0.5, 0.1, 0.5],            
    'maxAccel': [0.2, 0.2, 0.05, 0.2],         
    'maxJerk': [0.1, 0.1, 0.02, 0.1],          
    'timeStep': 0.01                           
}
movement_time=5
...
print(f"posição final do efetuador pelo coppelia: {sim.getObjectPosition(suctionPad, -1)}")
time.sleep(60)
